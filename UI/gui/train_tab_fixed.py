...
class TrainTab(QWidget):
    ...
    def create_config_panel(self):
        ...
        title.setStyleSheet("color: #2E7D32; padding: 5px;")  # EDITAR COLOR TÍTULO
        ...
        """)  # EDITAR ESTILO DE INFORMACIÓN DEL DATASET
    ...
    def create_progress_panel(self):
        ...
        title_font.setBold(True)
        title.setFont(title_font)
        title.setStyleSheet("color: #1976D2; padding: 5px;")  # EDITAR COLOR TÍTULO
        layout.addWidget(title)
        ...
        history_group.setMaximumHeight(100)  # Altura compacta
